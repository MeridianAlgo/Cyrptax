#!/usr/bin/env python3
"""
Professional Crypto Tax Web Application
Rivals paid services like Koinly and CoinMarketCap - but completely FREE!
"""
...
try:
    from src.auto_processor import process_crypto_taxes
...
def get_status():
    ...
    status = {
        ...
        'input_files': len([f for f in os.listdir('input') if os.path.isfile(os.path.join('input', f))]) if os.path.exists('input') else 0,
